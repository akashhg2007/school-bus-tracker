  ...
  Widget _buildTripCard({required String busNumber, required String driver, required String status, required Color statusColor}) {
    return Card(
      child: Padding(
        ...
        child: Row(
          children: [
            Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: statusColor.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)), child: Icon(Icons.directions_bus, color: statusColor)),
            const SizedBox(width: 12),
            ...
            Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4), decoration: BoxDecoration(color: statusColor.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(4)), child: Text(status, style: TextStyle(color: statusColor, fontSize: 12, fontWeight: FontWeight.bold))),
          ],
        ),
      ),
    );
